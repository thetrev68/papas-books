import type { TaxLineSummary } from '../../lib/reports';
import type { Transaction } from '../../types/database';

interface TaxLineReportViewProps {
  taxReportData: TaxLineSummary[];
...
/**
 * Tax line report view showing transactions grouped by tax line items.
 * Extracted from ReportsPage to reduce component complexity.
 */
export default function TaxLineReportView({
  taxReportData,
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead className="bg-neutral-100 dark:bg-gray-900 border-b-2 border-neutral-200 dark:border-gray-700">
            <tr>
              <th className="p-4 font-bold text-neutral-600 dark:text-gray-400">Tax Line Item</th>
